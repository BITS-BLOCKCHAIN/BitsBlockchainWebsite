                ...
                <li>
                  <a>
                    <select onChange={handleChange}>
                      ...
                      <option value="https://polygon.technology/ecosystem-jobs">
                        Polygon
                      </option>
                      <option value="https://web3.career/">Web3</option>
                      <option value="https://code4rena.com">
                        Bug Bounties
                      </option>
                    </select>
                  </a>
          ...
          {windowWidth < 768 && menuOpen && (
            <nav>
              <ul className="nav-menu-open">
                ...
                <li>
                  <a href="https://bits-blockchain.notion.site/BITS-Blockchain-Development-Task-1-Frontend-cc11f0969ee84daa8c8df4b1eb780692">
                    Resources
                  </a>
                </li>
                <li>
